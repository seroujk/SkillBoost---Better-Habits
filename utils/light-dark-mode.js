document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateButtonIcons(theme) {
      if (theme === 'dark') {
        if (themeToggle) themeToggle.style.backgroundImage = 'url(../../../images/buttons/sun.svg)';
        if (mobileThemeToggle) mobileThemeToggle.textContent = 'Light Mode ☀️';
      } else {
        if (themeToggle) themeToggle.style.backgroundImage = 'url(../../../images/buttons/moon.svg)';
